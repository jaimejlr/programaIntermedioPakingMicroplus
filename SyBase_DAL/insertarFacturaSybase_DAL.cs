            ...
            using (OdbcConnection connection = new OdbcConnection(SettingsConexion.Default.conexionSybase))
                try
                {
                    String SQL_query = "INSERT INTO encabezadofacturas " +
                         ...
                         " VALUES " +
                         " ('" + obj.codemp + "',  '"+obj.numfac+"','"+obj.codven+"', '"+obj.codalm+"', '"+obj.codcli+ "', getdate()  ,'"+obj.lispre+"', '"+obj.observ+"' ,"+obj.poriva+", "+obj.totnet+", "+obj.totdes+", "+obj.totbas+", "+obj.totfac+",  '2021-08-16 00:00:00.000', '"+obj.conpag+"', '"+obj.tipefe+"'    ,0.0000,'X',   NULL,    0.0000, 'X',         " + " NULL,  0.0000,    'X',      NULL,  0.0000,  'A'    ,1     , 0    ,  0.0000,   NULL    ,NULL,    2.6800, 'FCE0000866',1.0000, '01',   'TEAMPLUS','2021-08-16 00:00:00.000','P',       '"+obj.nomcli+"' , '"+obj.referen+"', '"+obj.codtrans+"' ,     'S',   0.0000, " + " NULL,  0.0000,   22.3200, NULL, '9999999999999', 'SN',   'E0',     NULL,  'X',   22.3200,  NULL      ,NULL,  0.0000, 25.0000, 0.0000,  0.0000,  '001103',    NULL,       'X',      0.0000,  0.0000, 0.0000, 2.6800, 22.3200,     0.0000,   " + "   0.0000,    0.0000,      'D',       null,   null,    '2021-08-17','2021-08-17',   '18',            '9999999999999','07',      NULL,    '"+obj.codveh + "',   0.0000,   0.0000,  0.0000, 'N',        NULL,   NULL,      NULL,       NULL,  NULL,         NULL,   '013',  0.0000, 'N',     " + "  NULL,             NULL            ,NULL                    ,NULL           ,NULL           ,NULL   ,null        ,0.0000  ,null           ,NULL     ,NULL       ,0.0000   ,NULL            ,NULL,       " + " '00:00:00.000','001'    ,0.0000     ,null        ,NULL    ,NULL         ,NULL       ,NULL       ,''        ,'N'       ,'"+obj.claveaccesofegui+"'  ,NULL             ,NULL       ,''        ,NULL      ,NULL   ,NULL        ,NULL         ,NULL         ,NULL  )";
                    connection.Open();
