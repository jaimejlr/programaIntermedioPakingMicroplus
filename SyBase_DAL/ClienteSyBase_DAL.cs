                    ...
                    if(codCliente =="")
                    {
                        ...
                        //**** CODCLA = Código del cliente padre.
                            ...
                            String SQL_query = "INSERT INTO clientes " +
                                                " ( codemp              , codcli            , codcla            ,apliva   ,nomcli               ,    rucced                   ,dircli                 ,      telcli             ,        contac          , ciucli                , mail                ,codalt                    , codcta , lispre ,  codusu       ,  dircli2                   , repcli                 , descu , cupo  , salact , tiprucced , forpag , estado,  especial, docrec02,  datcon01 , ivapres, parterel, codzona) " +
                                                " VALUES " +
